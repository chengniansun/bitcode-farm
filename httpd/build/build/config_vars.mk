...
shared_build =
AP_LIBS = /research-data/bitcode-farm/httpd/build/srclib/pcre/libpcre.la /research-data/bitcode-farm/httpd/build/srclib/apr-util/libaprutil-1.la /research-data/bitcode-farm/httpd/build/srclib/apr-util/xml/expat/libexpat.la /research-data/bitcode-farm/httpd/build/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /research-data/bitcode-farm/httpd/httpd-2.2.29
...
CPP = /home/neo/workspace/basic-block-analyzer/basic-block-analyzer/ll-parser/scripts/ll-cc.py -E
CXX = /home/neo/workspace/basic-block-analyzer/basic-block-analyzer/ll-parser/scripts/ll-cxx.py
CPPFLAGS =
CFLAGS =
CXXFLAGS =
LTFLAGS = --silent
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_builddir)/include -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/research-data/bitcode-farm/httpd/build/srclib/apr/include -I/research-data/bitcode-farm/httpd/httpd-2.2.29/srclib/apr/include -I/research-data/bitcode-farm/httpd/build/srclib/apr-util/include -I/research-data/bitcode-farm/httpd/httpd-2.2.29/srclib/apr-util/include -I/research-data/bitcode-farm/httpd/httpd-2.2.29/srclib/apr-util/xml/expat/lib -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /research-data/bitcode-farm/httpd/build/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
...
APR_INCLUDEDIR = /research-data/bitcode-farm/httpd/build/srclib/apr/include /research-data/bitcode-farm/httpd/httpd-2.2.29/srclib/apr/include
APR_VERSION = 1.5.1
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /research-data/bitcode-farm/httpd/build/srclib/apr-util/include /research-data/bitcode-farm/httpd/httpd-2.2.29/srclib/apr-util/include
APU_VERSION = 1.5.3
