...
#
apr_builddir=/research-data/bitcode-farm/httpd/build/srclib/apr
apr_builders=/research-data/bitcode-farm/httpd/httpd-2.2.29/srclib/apr/build
top_builddir=/research-data/bitcode-farm/httpd/build/srclib/apr

# Some layouts require knowing what version we are at.
APR_MAJOR_VERSION=1
APR_DOTTED_VERSION=1.5.1

CC=/home/neo/workspace/basic-block-analyzer/basic-block-analyzer/ll-parser/scripts/ll-cc.py
RM=rm
AWK=gawk
SHELL=/bin/bash
